	...
	public function form( $instance ) {
		...
		<?php
			...
			if(is_array($taxArrayData)){
				...
				?>
			<select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'chooseTax' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'chooseTax' ) ); ?>" >		
				<?php
				foreach($taxArrayData as $tax){
					?>
					<option value="<?php echo $tax; ?>" <?php if($selectedTax == $tax ){echo 'selected="selected"';}?>><?php echo $tax; ?></option>
					<?php
				}
			?></select><?php
			}
		...
		<p>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'hideEmpty' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'hideEmpty' ) ); ?>" type="checkbox" value="hide" <?php if($hideEmpty == 'hide'){ echo 'checked'; } ?> >
		...
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'excludeTerm' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'excludeTerm' ) ); ?>" type="text" value="<?php echo $excludeTerm; ?>" >
		<br/><small>(input comma seprated term id's)</small>
		</p>
		<?php 
	}
	/**
