...
<h2 align="center"> <br />
  <a href="https://wordpress.org/plugins/<?php _e( $ttwSlug, 'taxonomymanager' ); ?>" title="<?php _e( $ttwName, 'taxonomymanager' ); ?>" target="_blank"><?php echo $ttwPlugin->name; ?></a></h2>
<ul class="ttwTab">
  <li><a href="javascript:void(0)" class="ttwTablinks" onclick="ttwttwTabs(event, 'pluginDetails')" id="ttwDefaultOpen">Plugin Details</a></li>
  <li><a href="javascript:void(0)" class="ttwTablinks" onclick="ttwttwTabs(event, 'authorDetails')">Plugin Author Details </a></li>
  <li><a href="javascript:void(0)" class="ttwTablinks" onclick="ttwttwTabs(event, 'pluginDescription')">Plugin Description</a></li>
</ul>
<div id="pluginDetails" class="ttwTabcontent"> <span onclick="this.parentElement.style.display='none'" class="ttwCloseBtn">X</span>
...
?>
<div id="authorDetails" class="ttwTabcontent"> <span onclick="this.parentElement.style.display='none'" class="ttwCloseBtn">X</span>
  <table align="left" cellpadding="4" cellspacing="4" border="0" width="100%">
    <tr>
      <th>Plugin Author :</th>
    ...
    <tr>
      ...
      <td><a href="mailto:sunilkumarthz@gmail.com" title="sunilkumarthz@gmail.com">sunilkumarthz@gmail.com</a></td>
    </tr>
  </table>
</div>
<div id="pluginDescription" class="ttwTabcontent"> <span onclick="this.parentElement.style.display='none'" class="ttwCloseBtn">X</span>
