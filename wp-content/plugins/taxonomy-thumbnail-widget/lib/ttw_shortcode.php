			...
			if(is_array($taxData)){
				...
				foreach($taxData as $taxterm){
					...
					<li class="ttw_term_box term-<?php echo $termID; ?>">
						<a class="ttw-term-link" title="<?php echo $taxterm->name; ?>" href="<?php echo $getTermLink; ?>">
							<div class="img-container">
								<img class="wp-post-image ttw_image" src="<?php echo $thumbnailSrc; ?>" alt="<?php echo $termName; ?>">
							</div>
					...
					<li class="ttw_term_icon_box term-<?php echo $termID; ?>">
						<a class="ttw-term-link" title="<?php echo $taxterm->name; ?>" href="<?php echo $getTermLink; ?>">
							<div class="icon-img-container">
								<img class="wp-post-image ttw_icon_image" src="<?php echo $thumbnailSrc; ?>" alt="<?php echo $termName; ?>">
							</div>
							<h3 class="ttw-term-icon-title" itemprop="alternativeHeadline"><?php echo $taxterm->name; ?></h3>
						</a>
					</li>
					<?php
				}					
